										...
										for i5 in range(9):
											...
											for j5 in range(f(i5)):
												...
												for (x5,y5) in templist2:
													if  (dist(x5,y5,x3,y3)==900) or (dist(x5,y5,x3,y3)==3825):
														tempr2=tempr2+1	
										#print tempr,tempr2,x,y
										#tempr=tempr-tempr2
										p=1	
									#print tempr	
									if(tempr>max1) and ((x,y) not in templist1) and ((x,y) not in templist2) and p==1:
										max1,max2=tempr,tempr2
										z1=x
										z2=y
										tempx1=x3
										tempy1=y3
