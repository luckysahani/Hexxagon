											...
											for j1 in range(f(i1)):
												...
												for (x1,y1) in templist1:
													if  (dist(x,y,x1,y1)==900) or (dist(x,y,x1,y1)==3825):
														tempr=tempr+1
									#print"\n\n\n"	
									if(tempr==max1) and ((x,y) not in templist1) and ((x,y) not in templist2) and p3==0:			
										#max2=tempr2			
										z1=x
										z2=y
										tempx1=x3
										tempy1=y3
										p4=0		
									elif(tempr==max1) and ((x,y) not in templist1) and ((x,y) not in templist2) and p3==1 and p4==1:
										tempr2=0				
										for i1 in range(9):
											x1=(i1*60)+40
											for j1 in range(f(i1)):
												y1=20+(30*j1)+abs(i1-4)*15
												for (x1,y1) in templist2:
													if  (dist(x3,y3,x1,y1)==900) or (dist(x3,y3,x1,y1)==3825):
														tempr2=tempr2+1			
										if tempr2<max2:
											max2=tempr2			
											z1=x
